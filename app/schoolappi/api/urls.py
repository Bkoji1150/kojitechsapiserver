...
teacher.register(r'courses', CoursesInKojitechs, basename='coursesinKojitechs')
urlpatterns = [
    ...
    path("courses/<int:pk>/createreview", CreateView.as_view(), name="create-review" ),
    path("courses/<int:pk>/review", ReviewList.as_view(), name="review-list" ),
